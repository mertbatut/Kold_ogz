    ...
    <header className={`fixed w-full top-0 left-0 z-10 transition-all duration-300 ${scrolled ? 'bg-dark-bg text-white shadow-lg' : 'bg-none text-white'}`}>
      <nav className="container mx-auto p-4 flex justify-between items-center">
        ...
        <div className="hidden md:flex space-x-4 gap-28">
          ...
          <a onClick={() => handleMenuClick(scrollToStats)} className="hover:underline cursor-pointer">Presets</a>
          <a onClick={() => handleMenuClick(scrollToContact)} className="hover:underline cursor-pointer">Contact</a>
        </div>
      ...
      <div className={`md:hidden ${menuOpen ? 'block' : 'hidden'} bg-dark-bg text-white`}>
        <ul className="flex flex-col md:flex-row items-center md:space-x-4 space-y-4 md:space-y-0 p-4">
          <li><a onClick={() => handleMenuClick(scrollToWork)} className="hover:underline cursor-pointer">Work</a></li>
          <li><a onClick={() => handleMenuClick(scrollToProducts)} className="hover:underline cursor-pointer">Master Class</a></li>
          <li><a onClick={() => handleMenuClick(scrollToStats)} className="hover:underline cursor-pointer">Presets</a></li>
          <li><a onClick={() => handleMenuClick(scrollToContact)} className="hover:underline cursor-pointer">Contact</a></li>
        </ul>
      </div>
    </header>
  );
